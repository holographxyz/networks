...
*/
  ...
  ethereumTestnetSepolia: {
    ...
    color: '#83EEFF',
    chain: 5,
    rpc: process.env.ETHEREUM_TESTNET_GOERLI_RPC_URL || 'https://eth-sepolia.g.alchemy.com/v2/demo',
    holographId: 4000000011,
    tokenName: 'Ethereum Sepolia',
    tokenSymbol: 'ETH',
    explorer: 'https://sepolia.etherscan.io',
    lzEndpoint: '0x7cacBe439EaD55fa1c22790330b12835c6884a91'.toLowerCase(),
    lzId: 161,
    ccipEndpoint: '0xD0daae2231E9CB96b94C8512223533293C3693Bf'.toLowerCase(),
